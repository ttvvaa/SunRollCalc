...
namespace SunRollCalc.Controllers
{
    ...
    public class SunRollCalc
    {
        ...
        public EstimatePosition CalculateInt(InputValues v)
        {
            ...
            //		
            if (w > -1)
                return new EstimatePosition("Стоимость конструкции встроенного монтажа: ", priceInt[h, w]);
            else
            {
                ...
                return new EstimatePosition("Стоимость конструкции встроенного монтажа: ", Math.Truncate(price));
                //			
            }
        ...
        public EstimatePosition CalculateExt(InputValues v)
        {
            ...
            //		
            if (w > -1)
                return new EstimatePosition("Стоимость конструкции накладного монтажа: ", priceInt[h, w]);
            else
            {
                // 4.	Расчет стоимости по ширине проема по возможности сделать «плавающим». 
                int w1 = -1;
                ...
                return new EstimatePosition("Стоимость конструкции накладного монтажа: ", Math.Truncate(price));
                //			
            }
